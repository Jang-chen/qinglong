  ...
  async ["helpPackage"](T, c) {
    let C = {
      ...
      'headers': {
        ...
        'Cookie': "kpn=NEBULA; kpf=ANDROID_PHONE; did=ANDROID_e69f4364d7e80e85; " + Math["floor"](Math["random"]() * 1000 + 1) + " ANDROID_ff60a387f6ba8904; " + this['cookie'] + "; c=XIAOMI; ver=10.2; appver=10.2.41.3075; language=zh-cn; ",
